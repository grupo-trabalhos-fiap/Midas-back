...
public class EmailBo {
    ...
    private static final String EMAIL_FROM = "matheusmorais130306@gmail.com";
    private static final String APP_PASSWORD = "oljq eyix dkye fgzf";
